...
gcloud run services add-iam-policy-binding inventory-ai-service --member="serviceAccount:*YOUR_PROJECT_NUMBER*-compute@developer.gserviceaccount.com" --role="roles/run.invoker" --region=*YOUR REGION*
